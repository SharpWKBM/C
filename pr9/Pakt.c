...
void printDArray(int**, int, int);
int** createDArray(int, int);
void pr2(int);
void pr5(int);
int findMaxInRow(int**, int, int);
int findMinInCol(int**, int, int);
void pr3(int, int);
double plus(double, double);
double minus(double, double);
double razd(double, double);
...
int main()
{
    ...
    double a, b;
    void (*execute2)(int) = pr2;
    execute2(SIZE);
    printf("\n......................................\n");
    void (*execute3)(int, int) = pr3;
    execute3(ROW, COL);
    printf("\n......................................\n");
    void (*execute5)(int) = pr5;
    execute5(SIZE);
    printf("\n......................................\n");
    ...
    scanf("%lf", &b);
    double (*calc[4])(double, double) = { plus, minus, razd, umnoj };
    for (int i = 0; i < 4; i++) 
    {
        printf("%lf\n", calc[i](a, b));
    }
